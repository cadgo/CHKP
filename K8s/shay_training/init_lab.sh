...
az acr import --name $ACR_NAME --source docker.io/library/nginx:latest --image nginx:latest --resource-group myResourceGroup
az acr import --name $ACR_NAME --source docker.io/bkimminich/juice-shop:latest --image juice-shop:latest --resource-group myResourceGroup
